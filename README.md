...
- Pkg folder: [packages\slo-status](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\slo-status)
...
graph LR
  ...
  slo_status["slo_status"]:::center
  slo_status -->|FK| slo_windows["slo_windows"]:::link
...
- Outbound (depends on): "slo_windows"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package slo-status -Apply
