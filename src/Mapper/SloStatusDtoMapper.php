...
namespace BlackCat\Database\Packages\SloStatus\Mapper;

use BlackCat\Database\Packages\SloStatus\Dto\SloStatusDto;
use BlackCat\Database\Packages\SloStatus\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO SloStatusDto:
...
final class SloStatusDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'window_id', 'good_events', 'total_events' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'sli_value' ];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'computed_at' ];
    /** @var string[] */
     ...
     * @return SloStatusDto
     */
    public static function fromRow(array $row): SloStatusDto
    {
        /** @var SloStatusDto */
    ...
    public static function fromRowOrNull(?array $row): ?SloStatusDto
    {
     ...
     *
     * @param SloStatusDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SloStatusDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SloStatusDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SloStatusDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SloStatusDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SloStatusDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SloStatusDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SloStatusDto>
     */
