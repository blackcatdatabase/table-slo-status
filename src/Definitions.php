...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'slo_status'; }
    public static function contractView(): string { return 'vw_slo_status'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'window_id', 'computed_at', 'sli_value', 'good_events', 'total_events', 'status' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'window_id', 'computed_at' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'window_id', 'good_events', 'total_events' ]; }
