...
namespace BlackCat\Database\Packages\SloStatus\Dto;
 ...
 */
final class SloStatusDto implements \JsonSerializable {
    public function __construct(
        public readonly int $id,
        public readonly int $windowId,
        public readonly \DateTimeImmutable $computedAt,
        public readonly ?string $sliValue,
        public readonly int $goodEvents,
