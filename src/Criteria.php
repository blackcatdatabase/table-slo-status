...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'window_id', 'computed_at', 'sli_value', 'good_events', 'total_events', 'status' ];
    }
    ...
    {
        $x = [ 'id', 'window_id', 'computed_at', 'sli_value', 'good_events', 'total_events', 'status' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\SloStatus\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\SloStatus\Definitions::softDeleteColumn();
