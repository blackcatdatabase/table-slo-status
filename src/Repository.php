...
namespace BlackCat\Database\Packages\SloStatus;
...
use BlackCat\Database\Packages\SloStatus\Repository\SloStatusRepository as GeneratedRepository;
...
{
  private SloStatusRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SloStatusRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SloStatusRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SloStatus\Dto\SloStatusDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SloStatus\Dto\SloStatusDto|null { return $this->repo->getById($id, $asDto); }
