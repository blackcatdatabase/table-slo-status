...
use BlackCat\Database\Packages\SloStatus\Repository\SloStatusRepository;
...
{
    private SloStatusRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new SloStatusRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SloStatus\Dto\SloStatusDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SloStatus\Dto\SloStatusDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SloStatus\Dto\SloStatusDto|null
    {
