...
final class SloStatusModule implements ModuleInterface
{
    public function name(): string { return 'table-slo_status'; }
    public function table(): string { return 'slo_status'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-slo_windows' ]; }

    public static function contractView(): string { return 'vw_slo_status'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_slo_status_window' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_slo_status_window' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_slo_status_window' ],
            'foreignKeys' => [ 'fk_slo_status_window' ],
        ];
    }
}
